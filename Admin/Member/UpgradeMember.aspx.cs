...
public partial class Admin_Member_UpgradeMember : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (Update_Ok != 0)
            {
                ...
                ScriptManager.RegisterStartupScript(
                        ...
                        this.GetType(),
                        "MessageBox",
                        "alert('Member Upgraded');window.location='ViewMembers.aspx';", true);
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btnPay_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ccavRequestHandler.aspx?&billing_address=" + address + "&billing_city=" + city + "&billing_state=" + state + "&billing_zip=" + pin + "&billing_country=" + country + "&merchant_id=53386&order_id=" + orderno + "&currency=INR&amount=" + amount + "&redirect_url=http://swapnpurti.in/Admin/Member/ccavResponseHandler.aspx&cancel_url=http://swapnpurti.in/Admin/Member/ccavResponseHandler.aspx&billing_name=" + txtMemName.Text + "&billing_email=" + lblEmail.Text + "&billing_tel=" + lblMobNo.Text + "&merchant_param1=" + packageno + "&merchant_param2=" + mId + "&merchant_param3=" + lblpackName.Text + "&merchant_param4=" + dtme[0].ToString() + "&merchant_param5=" + dtme[1].ToString() + "");
    }

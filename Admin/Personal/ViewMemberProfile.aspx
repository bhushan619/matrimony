<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewMemberProfile.aspx.cs" Inherits="Admin_Personal_ViewMemberProfile" %>
	...
	<div class="container">     
            ...
            <div class="panel-heading">
              <h3 class="panel-title"> View Member Details
                ...
                <a href="Default.aspx" class="backbtn">Back</a></h3>
            </div>  
                ...
                <div class="col-lg-5">
                     ...
                     <dt>Paid Amount</dt>
	                            <dd>:  <asp:Label ID="lblmyamt" runat="server"></asp:Label></dd>  
                                  <dt>Paymode</dt>
	                            <dd>:  <asp:Label ID="lblmypaymode" runat="server"></asp:Label></dd>                                  
                     </dl>
             </div>

<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs" Inherits="Admin_EditProfile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Swapnpurti Matrimony |  Edit Profile</title>  <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />   <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<body>
   ...
   <%-- <asp:Image ID="imgAdminPhoto" runat="server" Height="50px" Width="50px" />
    <br />
           ...
           <div class="col-lg-2"></div>
            ...
            <div class=" panel-body">
                ...
                <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                               <asp:TextBox ID="txtName"  required="required" runat="server" CssClass="form-control"></asp:TextBox>
                              </div>
                       </div>
             </div>  
               ...
               <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                               <asp:TextBox ID="txtAddress" TextMode="MultiLine"  required="required" runat="server" CssClass="form-control"></asp:TextBox>
                              </div>
                       </div>
             </div>  
...
<asp:ListItem>Zimbabwe</asp:ListItem> 
 ...
 <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                           <asp:DropDownList ID="cmbstate" runat="server"  required="required" AppendDataBoundItems="true" 
    ...
    <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                            <asp:DropDownList ID="cmbcity" runat="server"  required="required" AppendDataBoundItems="true" CssClass="form-control" >
         ...
         <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                            <asp:TextBox ID="txtemail" runat="server" CssClass="form-control"  required="required" pattern="[a-z0-9!#$%&'*+/=?^_{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+(?:[A-Z]{2}|com|org|net|edu|gov|mil|biz|info|mobi|name|aero|asia|jobs|museum|co|in|co.in)"></asp:TextBox>
     ...
     <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                               <asp:TextBox ID="txtMobile" runat="server" required="required" pattern="[7-9]{1}[0-9]{9}" MaxLength="10" CssClass="form-control"></asp:TextBox>
                              </div>
                       </div>
             </div>
      ...
      <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                              <asp:TextBox ID="txtPinCode"  runat="server" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" CssClass="form-control"></asp:TextBox><br />
     ...
     <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                            <asp:TextBox ID="txtLandLine" runat="server" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" CssClass="form-control"></asp:TextBox>
        ...
        <div class="fileupload fileupload-new" data-provides="fileupload">
            <div> <div class="row"> 
                         <div class="col-md-5"> 
                                 <div class="form-group">   
                               <span> <span class="fileupload-new">Select image</span> </span> 
                                 </div> 
                          </div> 
                      <div class="col-md-7">
                             <div class="form-group"> 
                        
       <span class="btn btn-file btn-success">         <input id="fupProPic" runat="server" accept="image/*" name="file"   onchange="previewFile()" type="file" /></span> 
                                <br /> <br />  <asp:Image ID="imgProPic" runat="server"     CssClass="fileupload-preview thumbnail" ImageUrl="~/Admin/media/"  style="width: 200px; height: 150px;float:none" />
                              </div>
                       </div>
             </div>
   ...
   <div class="row"> 
                      ...
                      <div class="col-md-7">
                             <div class="form-group"> 
                            <asp:Button ID="btnUpdate"  runat="server" Text="Update" OnClick="txtUpdate_Click" CssClass="btn btn-warning"/>
                            <asp:Button ID="btnCancel" runat="server"   Text="Cancel" onclick="btnCancel_Click" CssClass="btn btn-danger"/>  </div>     </div>
                       </div>
             </div>
 </div> </div></div></div>

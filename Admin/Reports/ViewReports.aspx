<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="ViewReports.aspx.cs" Inherits="Admin_Reports_ViewReports" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Swapnpurti Matrimony |  View Reports</title>  <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />   <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<div class="col-lg-12">
   ...
   <div class="row">
       ...
       <div class="col-lg-2"> <img src="../../images/report.png" /></div> 
        <div class="col-lg-6">
       
    <a href="PackageData.aspx" title="Package Data" class="btn btn-success"><img src="../../images/pack.png" height="25" width="25" />&nbsp;&nbsp;Package Data&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><br /><br />
           <a href="MemberData.aspx" title="Members Data" class="btn btn-warning"> <img src="../../images/mem.png" height="25" width="25" />&nbsp;&nbsp;Members Data&nbsp;&nbsp;&nbsp;</a><br /><br />
                  <a href="FranchiseeData.aspx" title="Franchisee Data" class="btn btn-info">  <img src="../../images/fran.png" height="25" width="25" />&nbsp;&nbsp; Franchisee Data</a>
   </div> </div></div>
            </div>
             <div class="footer">
	<div class="container">

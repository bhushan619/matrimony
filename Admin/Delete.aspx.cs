...
public partial class Admin_Delete : System.Web.UI.Page
{
    ...
    public void alldelet()
    {
        try
        {
            ...
            MySql.Data.MySqlClient.MySqlCommand cmda = new MySql.Data.MySqlClient.MySqlCommand("delete from tblamemailpreferences", dbc.con);
            dbc.con.Open();
            cmda.ExecuteReader();
            dbc.con.Close();
            ...
            //MySql.Data.MySqlClient.MySqlCommand cmd51a = new MySql.Data.MySqlClient.MySqlCommand("delete from tblampackages", dbc.con);
            //dbc.con.Open();
            //cmd51a.ExecuteReader();
            //dbc.con.Close();

            //MySql.Data.MySqlClient.MySqlCommand cmd52 = new MySql.Data.MySqlClient.MySqlCommand("delete from tblampackagesdetails", dbc.con);
            //dbc.con.Open();
            //cmd52.ExecuteReader();
            //dbc.con.Close();
            ...
            MySql.Data.MySqlClient.MySqlCommand cmd53aa = new MySql.Data.MySqlClient.MySqlCommand("delete from tblampersonnelbankdetails", dbc.con);
            dbc.con.Open();
            cmd53aa.ExecuteReader();
            dbc.con.Close();

            MySql.Data.MySqlClient.MySqlCommand cmd53saa = new MySql.Data.MySqlClient.MySqlCommand("delete from tblamprofilestatus", dbc.con);
            dbc.con.Open();
            cmd53saa.ExecuteReader();
            dbc.con.Close();
            ...
            MySql.Data.MySqlClient.MySqlCommand cmd5a = new MySql.Data.MySqlClient.MySqlCommand("delete from tblmembercontactviewscount", dbc.con);
            dbc.con.Open();
            cmd5a.ExecuteReader();
            dbc.con.Close();

<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditPackage.aspx.cs" Inherits="Admin_EditPackage" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Swapnpurti Matrimony |  Edit Packages</title>  <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />   <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<div class="col-lg-12">
                 ...
                 <li ><a href="../Personal/Default.aspx">Home</a></li> 
                    ...
                    <li ><a href="EditPackage.aspx">Edit Package Details</a></li> 
	...
	<div class="container">     
           ...
           <div class="col-lg-2"></div>
            ...
            <div class="panel-heading">
              <h3 class="panel-title"> Edit Package Details <a href="ViewPackage.aspx" class="backbtn">Back</a></h3>
            </div>  

<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="RejectSuccessStory.aspx.cs" Inherits="Admin_RejectSuccessStory" %>
...
<div class="col-lg-12">
                 ...
                 <li ><a href="../Personal/Default.aspx">Home</a></li> 
                       ...
                       <li ><a href="RejectSuccessStory.aspx">Reject Success Story</a></li> 
         ...
         <div class="col-lg-10">  
           <div class="col-lg-1"></div>
            ...
            <div class="panel-heading">
              <h3 class="panel-title"> Rejected Success Story</h3>
            </div>  
           ...
           <asp:GridView ID="grdSuccessStory" runat="server" AllowPaging="True"  CssClass=" table table-bordered"
            ...
            <HeaderTemplate>Operation</HeaderTemplate>
                <ItemTemplate>
                     ...
                     <asp:LinkButton ID="LinkButton1" runat="server" Text="Approved" CommandName="Approve"  CommandArgument='<%#Eval("varMemberId") %>'  CssClass="fa  fa-check btn btn-link "/>

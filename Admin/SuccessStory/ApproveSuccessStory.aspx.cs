...
public partial class Admin_ApproveSuccessStory : System.Web.UI.Page
{
    ...
    public void getDataInGridview()
    {
        ...
        {
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT varMemberId,varMemberName,varWeddingDate,varCurrentState,varCurrentCity,varCurrentContact FROM anuvaa_matrimony.tblamsuccessstories WHERE varStatus='Approve'", dbc.con);
        ...
        try
        {
            ...
            if (e.CommandName == "Reject")
            {
                ...
                ScriptManager.RegisterStartupScript(
                    ...
                    this.GetType(),
                    "MessageBox",
                    "alert('Success Story Reject!!!');window.location='ApproveSuccessStory.aspx';", true);
            }

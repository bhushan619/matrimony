<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="SuccessStory.aspx.cs" Inherits="Admin_SuccessStory" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Swapnpurti Matrimony |   Success Story</title>  <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />   <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
        ...
        <div class="col-lg-1"></div>
         <div class="col-lg-10">  
            ...
            <div class="panel-heading">
              <h3 class="panel-title">Unverified Success Story</h3>
            </div>  
                
            <div class=" panel-body">   <div class="table-responsive"> 
   <div class="col-lg-12">
        <asp:GridView ID="grdSuccessStory" runat="server" AllowPaging="True" CssClass="table table-bordered"
            AutoGenerateColumns="False"          onrowcommand="grdSuccessStory_RowCommand" >
            ...
            <HeaderTemplate>Operation</HeaderTemplate>
                <ItemTemplate>
                <asp:LinkButton ID="lnkbtnEdit" runat="server" Text="Approved" CommandName="Approve"  CommandArgument='<%#Eval("varMemberId") %>'  CssClass=" fa  fa-check btn btn-link "/>

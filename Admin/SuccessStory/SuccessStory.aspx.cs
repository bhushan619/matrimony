...
public partial class Admin_SuccessStory : System.Web.UI.Page
{
    ...
    public void getDataInGridview()
    {
        ...
        {
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT varMemberId,varMemberName,varWeddingDate,varCurrentState,varCurrentCity,varCurrentContact FROM anuvaa_matrimony.tblamsuccessstories WHERE varStatus='Unverified'", dbc.con);
        ...
        try
        {
            ...
            if (e.CommandName == "Approve")
            {
                ...
                ScriptManager.RegisterStartupScript(
                    ...
                    this.GetType(),
                    "MessageBox",
                    "alert('Success Story Approve!!!');window.location='SuccessStory.aspx';", true);
            }
            else if (e.CommandName == "Reject")
            {
                ...
                ScriptManager.RegisterStartupScript(
                    ...
                    this.GetType(),
                    "MessageBox",
                    "alert('Success Story Reject!!!');window.location='SuccessStory.aspx';", true);
            }

...
<div class="checkbox pull-left mt-10">
                  ...
                  <asp:CheckBox ID="cbkTC" runat="server" />  
                    I have read and agree to the <a href="../TandC.aspx" target="_blank" class="text-theme-colored">Terms of Use</a> & <a href="../privacy/index.html" target="_blank" class="text-theme-colored">Privacy policy</a>. </label>
                  </div>
                            </div>
                      </div>
                   <div class="row">  
            ...
            onclick="btnRegister_Click" OnClientClick="if(!this.form.cbkTC.checked){alert('You must agree to the terms first.');return false}" />
 <br />

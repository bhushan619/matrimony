...
public partial class members_Activities_InterestInProfile : System.Web.UI.Page
{
    ...
    protected void DeleteInterestedInProfile(object sender, EventArgs e)
    {
        dbc.con.Close();
        string delId = (sender as LinkButton).CommandArgument;
        MySql.Data.MySqlClient.MySqlCommand cmd47 = new MySql.Data.MySqlClient.MySqlCommand("delete from tblammemberinterests where varInterestInId='" + delId + "'", dbc.con);

        dbc.con.Open();
        cmd47.ExecuteReader();
        dbc.con.Close();
        Response.Redirect("InterestedInProfile.aspx");
    }
    ...
    public void getInterestedProfiles()
    {
        ...
        dt.Columns.AddRange(new DataColumn[18] {             
                        ...
                        new DataColumn("IntersestMemDate", typeof(string)),
        ...
        MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("SELECT varInterestInId  as IntersestMemId, varDate as IntersestMemDate FROM tblammemberinterests WHERE ( varInterestOfId= '" + Session["memberid"].ToString() + "') ORDER BY RAND() LIMIT 0,9", cnn1);
            ...
            while (rdr1.Read())
            {
                ...
                if (gender[1] == gen)
                {
                  ...
                  //  MySql.Data.MySqlClient.MySqlCommand cmd8 = new MySql.Data.MySqlClient.MySqlCommand("SELECT DISTINCT tblampackages.varPackageName as IntersestMemPackage FROM tblammembertransactions, tblampackages WHERE (tblammembertransactions.varMemberId = '" + IntersestMemId + "')", cnn8);
                    MySql.Data.MySqlClient.MySqlCommand cmd8 = new MySql.Data.MySqlClient.MySqlCommand("SELECT (SELECT distinct varPackageName FROM tblampackages WHERE varPackageId=tblammembertransactions.varPackageId) as IntersestMemPackage FROM tblammembertransactions WHERE varMemberId='" + IntersestMemId + "' order by intId asc", cnn8);
                    ...
                    dt.Rows.Add(IntersestMemId, IntersestMemDate, IntersestMemName, IntersestMemAccFor, IntersestMemPhoto, IntersestMemAbout, IntersestMemAge, IntersestMemReligion, IntersestMemCaste, IntersestMemSCaste, IntersestMemCity, IntersestMemState, IntersestMemCountry, IntersestMemEducation, IntersestMemOccupation, IntersestMemHeight, IntersestMemHeightcm, IntersestMemPackage);
                    // Empty strings
                    IntersestMemId = string.Empty;
                    IntersestMemDate = string.Empty;

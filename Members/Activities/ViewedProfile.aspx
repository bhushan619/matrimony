<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="ViewedProfile.aspx.cs" Inherits="members_Activities_ViewedProfile" %>
...
<a href="Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	<div class="container">		      
               <div class="col-lg-8">
    <h3>    Profiles I Viewed </h3> 
                      <div class="borsolid"></div>  
   <span class="j10font"> The members that I have Viewed are displayed here.</span> <br />
         ...
         <div class="col-lg-12" style="background-color: #f3ffff">
             <div class="row "> 
                 <br />
                 <div class="col-lg-4 ">
                     <div class="jsideleft"> &nbsp;&nbsp;
  ...
  &nbsp;&nbsp; <asp:LinkButton ID="lblname" runat="server"    CommandArgument='<%# Eval("ViewMemId") %>' OnClick="OpenProfile" Text='<%# Eval("ViewMemPackage") %>'></asp:LinkButton>&nbsp;&nbsp;
...
<asp:LinkButton ID="LinkButton2" runat="server"    CommandArgument='<%# Eval("ViewMemId") %>'  OnClick="OpenProfile" Text="View  Profile"></asp:LinkButton>
   ...
   <div class="col-lg-2 bsideleft" >
     <asp:ImageButton ID="imgSimilarPic" runat="server"  CssClass="img-rounded" Height="110px" Width="110px" OnClick="imgmember_Click"  CommandArgument='<%# Eval("ViewMemId")+";"+ Eval("ViewMemPhoto") %>'        ImageUrl='<%# "~/members/media/" + Eval("ViewMemPhoto") %>' /> 
      </div>
...
Religion :    <asp:Label ID="ReligionLabel" runat="server" Text='<%# Eval("ViewMemReligion") %>' /><br /> 
 ...
 Education :   <asp:Label ID="EducationLabel" runat="server" Text='<%# Eval("ViewMemEducation") %>' /> <br />
    Occupation :        <asp:Label ID="Label4" runat="server" Text='<%# Eval("ViewMemOccupation") %>' />  <br />
      ...
      <div class="row " style="background-color: #f3ffff;padding-bottom: 7px;">

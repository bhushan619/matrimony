...
public partial class members_Activities_ViewedProfile : System.Web.UI.Page
{
    ...
    public void getViewedProfiles()
    {
        ...
        //get viewed profiles
        MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("SELECT varViewedMemberId as ViewMemId, varDate as ViewMemDate FROM tblamemberview WHERE (varMemberId = '" + Session["memberid"].ToString() + "')  ORDER BY RAND() LIMIT 0,9", cnn1);

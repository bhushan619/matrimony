...
public partial class members_Activities_WhoViewedMyProfile : System.Web.UI.Page
{
    ...
    public void getViewedProfiles()
    {
        ...
        MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("SELECT varMemberId as ViewMemId, varDate as ViewMemDate FROM tblamemberview WHERE (varViewedMemberId = '" + Session["memberid"].ToString() + "') ORDER BY RAND() LIMIT 0,9", cnn1);
        ...
        using (cnn1)
        {
            ...
            while (rdr1.Read())
            {
                ...
                if (gender[1] == gen)
                {
                    ...
                    MySql.Data.MySqlClient.MySqlCommand cmd8 = new MySql.Data.MySqlClient.MySqlCommand("SELECT (SELECT distinct varPackageName FROM tblampackages WHERE varPackageId=tblammembertransactions.varPackageId) as ViewMemPackage FROM tblammembertransactions WHERE varMemberId='" + ViewMemId + "' order by intId asc", cnn8);

<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="InterestedInProfile.aspx.cs" Inherits="members_Activities_InterestInProfile" %>
...
<!DOCTYPE html >
 ...
 <head>
<title>Swapnpurti Matrimony | Interested In Profiles</title>     <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<a href="Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	<div class="container">		      
               <div class="col-lg-8">
    <h3>    Interested In Profiles </h3> 
                      <div class="borsolid"></div>  
   <span class="j10font"> The members that you have Interested In are displayed here.</span> <br />
                <div class="bsideright" >  <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lstViewedProfiles" PageSize="10"  >
                     <Fields>
        ...
        <asp:ListView ID="lstViewedProfiles" runat="server" OnPagePropertiesChanging="OnPagePropertiesChanging"
         ...
         <div class="col-lg-12" style="background-color: #FEF8FB">
             <div class="row "> 
                 <br />
                 <div class="col-lg-4 ">
                     <div class="jsideleft"> &nbsp;&nbsp;<asp:LinkButton ID="lblCollege" runat="server"    CommandArgument='<%# Eval("IntersestMemId") %>'  OnClick="OpenProfile" Text='<%# Eval("IntersestMemId") %>' Font-Bold="true" Font-Size="17px"></asp:LinkButton> 
...
<asp:LinkButton ID="LinkButton2" runat="server"    CommandArgument='<%# Eval("IntersestMemId") %>'  OnClick="OpenProfile" Text="View  Profile"></asp:LinkButton>&nbsp;&nbsp;
    <asp:LinkButton ID="LinkButton3" runat="server"    CommandArgument='<%# Eval("IntersestMemId") %>'   OnClick="DeleteInterestedInProfile" Text="Delete"></asp:LinkButton>
         <br /><br /></div> </div>

             </div>
  
   <div class="col-lg-2 bsideleft" >
       <asp:ImageButton ID="imgSimilarPic" runat="server" CssClass="img-rounded" Height="110px" Width="110px" OnClick="imgmember_Click"    CommandArgument='<%# Eval("IntersestMemId")+";"+Eval("IntersestMemPhoto") %>'   ImageUrl='<%# "~/members/media/" + Eval("IntersestMemPhoto") %>' /> 
...
<div class="col-lg-7" >
     Profile Created For <asp:Label ID="Label9" runat="server" Text='<%# Eval("IntersestMemAccFor") %>' />,
&nbsp;<asp:Label ID="Label10" runat="server" Text='<%# Eval("IntersestMemName") %>' /><br /> 
...
Religion :    <asp:Label ID="ReligionLabel" runat="server" Text='<%# Eval("IntersestMemReligion") %>' /><br /> 
 ...
 Education :   <asp:Label ID="EducationLabel" runat="server" Text='<%# Eval("IntersestMemEducation") %>' /> <br />
    Occupation :        <asp:Label ID="Label4" runat="server" Text='<%# Eval("IntersestMemOccupation") %>' /> 
  </div>  </div> 
         </div> 
      <div class="row " style="background-color: #FEF8FB;padding-bottom: 7px;">
   <div class="bordex"></div>  
          <div class="jsideright "> 
           <asp:LinkButton ID="LinkButton1" runat="server"    CommandArgument='<%# Eval("IntersestMemId") %>'   OnClick="OpenProfile" Text="View Full Profile" class="btn btn-info btn-xs"></asp:LinkButton> &nbsp;&nbsp;

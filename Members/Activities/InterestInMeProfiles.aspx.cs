...
public partial class members_Activities_InterestInMeProfiles : System.Web.UI.Page
{
    ...
    public void getInterestedProfiles()
    {
        ...
        MySql.Data.MySqlClient.MySqlCommand cmd1 = new MySql.Data.MySqlClient.MySqlCommand("SELECT varInterestOfId as IntersestMemId, varDate as IntersestMemDate FROM tblammemberinterests WHERE (varInterestInId = '" + Session["memberid"].ToString() + "') ORDER BY RAND() LIMIT 0,9", cnn1);

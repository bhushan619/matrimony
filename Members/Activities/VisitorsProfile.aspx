<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="VisitorsProfile.aspx.cs" Inherits="members_Activities_WhoViewedMyProfile" %>

<!DOCTYPE html >

 <html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Swapnpurti Matrimony | Who Viewed My Profile</title>     <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<a href="Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	<div class="container">		      
               <div class="col-lg-8">
        <h3> Members who Viewed your Profile </h3>
                   <div class="borsolid"></div>  
                   <span class="j10font"> The following  members  Viewed your profile.</span> 
                   <br />
   ...
   <div class="col-lg-8 "> 
       <div class="jsideright"> Visited On: <asp:Label ID="Label7" runat="server" Text='<%# Eval("ViewMemDate") %>' />  
           </div> </div>
             </div>
   <div class="col-lg-2 bsideleft" >
           
     <asp:ImageButton ID="imgSimilarPic" runat="server"  Height="94px" Width="94px" CssClass="img-thumbnail" OnClick="imgmember_Click"   CommandArgument='<%# Eval("ViewMemId")+";"+Eval("ViewMemPhoto") %>'    ImageUrl='<%# "~/members/media/" + Eval("ViewMemPhoto") %>' />
               </div>
...
&nbsp;
 (<asp:LinkButton ID="Label10" runat="server" Text='<%# Eval("ViewMemName") %>'   CommandArgument='<%# Eval("ViewMemId") %>' OnClick="OpenProfile" Font-Bold="true" Font-Size="17px"></asp:LinkButton> )
    ...
    <br /><br />  <asp:Label ID="AgeLabel" runat="server" Text='<%# Eval("ViewMemAge") %>' />,
   <asp:Label ID="HeightLabel" runat="server" Text='<%# Eval("ViewMemHeight") %>' /> /
           <asp:Label ID="Label6" runat="server" Text='<%# Eval("ViewMemHeightcm") %>' /> | 
<b>Religion :   </b> <asp:Label ID="ReligionLabel" runat="server" Text='<%# Eval("ViewMemReligion") %>' />,
 Caste :     <asp:Label ID="CasteLabel" runat="server" Text='<%# Eval("ViewMemCaste") %>' />,
 Subcaste :     <asp:Label ID="Label5" runat="server" Text='<%# Eval("ViewMemSCaste") %>' /> |<br />
 <b> Location :</b> <asp:Label ID="Label3" runat="server" Text='<%# Eval("ViewMemCity") %>' />,  
       <asp:Label ID="Label2" runat="server" Text='<%# Eval("ViewMemState") %>' /> ,
         <asp:Label ID="CityLabel" runat="server" Text='<%# Eval("ViewMemCountry") %>' /> | 
 <b>Education : </b>  <asp:Label ID="EducationLabel" runat="server" Text='<%# Eval("ViewMemEducation") %>' /> |<br />
  <b>  Occupation : </b>       <asp:Label ID="Label4" runat="server" Text='<%# Eval("ViewMemOccupation") %>' /> <br /> 
   ...
   <%-- About <asp:Label ID="Label11" runat="server" Text='<%# Eval("ViewMemAccFor") %>' />: 
     <asp:Label ID="lblDescription" runat="server"  Text='<%# Limit(Eval("ViewMemAbout"),40) %>'   Tooltip='<%# Eval("ViewMemAbout") %>'>
      </asp:Label>--%>

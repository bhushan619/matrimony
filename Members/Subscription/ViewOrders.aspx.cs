...
public partial class Members_Subscription_ViewOrders : System.Web.UI.Page
{
    ...
    public void getDataInGridview()
    {
        try
        {
            ...
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT varMemberId,varMemberName,varPaymentAmount,varPaymentStatus,(SELECT varPackageName FROM tblampackages WHERE varPackageId=tblammembertransactions.varPackageId) as PackageName,varOrderStatus FROM tblammembertransactions WHERE varMemberId='" + Session["memberid"].ToString() + "'", dbc.con);
            ...
            cmd.Dispose();
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmdc = new MySql.Data.MySqlClient.MySqlCommand("SELECT varToView,varViewed FROM tblmembercontactviewscount WHERE varMemberId='" + Session["memberid"].ToString() + "'", dbc.con);

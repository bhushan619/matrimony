<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="ViewPackage.aspx.cs" Inherits="members_Subscription_ViewPackage" %>
    ...
    <asp:ListView ID="ListView1" runat="server"  
       onitemcommand="ListView1_ItemCommand">
        ...
        <ItemTemplate>
          ...
          <asp:LinkButton runat="server" CssClass="loginbtn" CommandArgument='<%# Eval("varPackageId")+";"+ Eval("varPackageName") +";"+ Eval("varPackageDuration") +";"+ Eval("varPackageDurationTime") %>' CommandName="buy">Buy</asp:LinkButton>
          </div>
                        </div>
                        </div>
                </span>

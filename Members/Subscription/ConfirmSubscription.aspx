<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="ConfirmSubscription.aspx.cs" Inherits="members_Subscription_ConfirmSubscription" %>
...
<a href="../Activities/Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
   ...
   <div class="container">
	...
	<div class="container">	
        <div class="row"> 
             <h2>Order No. : <asp:Label ID="lblOrderNo" runat="server" Text=""></asp:Label> 
  <asp:Label ID="lblOrderStatus" runat="server" Text="Label"></asp:Label></h2>
     ...
     <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" 
       ...
       <LayoutTemplate>
              ...
              <div class="col-lg-4">
    <a href="ViewOrders.aspx" class="loginbtn btn fa fa-3x" >View Orders</a>
                  <br />
               <a href="../Activities/Home.aspx" class="btn-primary btn fa-3x fa" >Go To Home</a>
           </div>
             </div>

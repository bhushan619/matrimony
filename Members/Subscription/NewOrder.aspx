<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="NewOrder.aspx.cs" Inherits="members_Subscription_NewOrder" %>
<!DOCTYPE html
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Swapnpurti Matrimony |  New Order</title>     <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<a href="../Activities/Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
 ...
 <%-- <asp:Label ID="lblOrderStatus" runat="server" Text=""></asp:Label>--%>
            ...
            <div class="col-lg-4">
               <h2>Order No. : <asp:Label ID="lblOrderNo" runat="server" Text=""></asp:Label> </h2>
   ...
   <asp:LinkButton ID="lnkProceed" runat="server" CssClass="loginbtn fa-2x fa text-center" onclick="lnkProceed_Click" Width="200px">Order Now</asp:LinkButton>
               <br />
               <a href="../Activities/Home.aspx" class="btn-primary btn fa-2x fa text-center"  style="width:200px">Cancel</a>
           </div>
               </div>

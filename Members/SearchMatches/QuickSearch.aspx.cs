...
public partial class Search_QuickSearch : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (ddlMotherTongue.Text == "--Select Mother Tongue--")
        {

        }
        else
        {
            query = query + "&Mothertoung=" + ddlMotherTongue.Text;
            searchby = searchby + "_mothertong";
        }
        ...
        if (ddlCaste.Text == "--Select--")
        {

        }
        else
        {
            query = query + "&Caste=" + ddlCaste.Text;
        ...
        {
            query = query + "&City=" + ddlcity.Text;
            searchby = searchby + "_city";
        }
        Response.Redirect("Search_Result.aspx?" + query + "&SearchBy=" + searchby + "");
    }
}
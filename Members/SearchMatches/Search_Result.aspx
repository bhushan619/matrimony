<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="Search_Result.aspx.cs" Inherits="Members_SearchMatches_Search_Result" %>
...
<div class="franchisee">
    ...
    <li><a href="../Activities/Home.aspx">Home</a></li>
                     <li><a href="QuickSearch.aspx">Search Members</a> </li>
    <li>Search Results</li>  
</ul>	 </div>   
                        <div class="col-lg-1 text-right" style="margin-top:3px">
                            <asp:HyperLink runat="server" ID="hypLinkBack" CssClass="loginbtn" NavigateUrl="~/Members/SearchMatches/QuickSearch.aspx"  >Back</asp:HyperLink>
                        </div>      
               <div class="col-lg-8">
    <h3>Search Results </h3>    <div class="borsolid"></div>
                       <span class="j10font">(count how many) People Match Your Search Criteria.</span>    <br />   

<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="members_UserProfile_MyProfile" %>
			...
			<div class="container">
		      <div class="header-main">
				...
				<div class="head-right-member">
					<ul>
                        <li> 
                  <asp:HyperLink ID="lnkNotifications" NavigateUrl="~/members/Activities/Notification.aspx" ToolTip="Notification" runat="server"
                       CssClass="notif"> </asp:HyperLink> 
                            
                            <br /> <asp:Label ID="lblmemUpgrade" runat="server"  ></asp:Label>  
              
           <asp:HyperLink Text="Upgrade"    runat="server" ID="lnkUpgrade" NavigateUrl="~/members/Subscription/ViewPackage.aspx"></asp:HyperLink></li>
	...
	<script>
	    $(".progress-bar").loading();
                        ...
                        <li> 
                           ...
                           <li>  
                                 <asp:HyperLink ID="lblMemberName" runat="server" Text=""  NavigateUrl="~/Members/SearchMatches/Default.aspx"></asp:HyperLink>&nbsp;&nbsp;<asp:LinkButton ID="lnkLogout" CssClass="logout" runat="server" OnClick="lnkLogout_Click"></asp:LinkButton><br />
...
<div id="getMemberDatas" runat="server" >
	   ...
	   <div class="col-lg-8 bhoechie-tab-container">
        ...
        <asp:Label ID="lblFullSubcaste" runat="server" />,<br />
         ...
         <asp:Label ID="lblFullEducation" runat="server" />,<br />

<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="EditLifeStyleDetails.aspx.cs" Inherits="members_UserProfile_Partner_EditLifeStyleDetails" %>
...
<li> <a href="../../Setting/ChangePassword.aspx">Settings</a></li>
   ...
   <li><a href= "EditLifeStyleDetails.aspx">Edit Partner Lifestyle Details</a></li>
</ul>
		 </div>  </div> 
                    <div class="row">
       ...
       <div class="row"> 
        ...
        <asp:ListItem>Occasionally</asp:ListItem>
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-md-8">
             <div class="form-group"> 
        <asp:Button ID="btnLifeStyleSave" runat="server" Text="Save"   onclick="btnLifeStyleSave_Click" CssClass="loginbtn"/>
     </div></div>

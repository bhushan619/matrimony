<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="EditFamilyDetails.aspx.cs" Inherits="members_UserProfile_Partner_EditFamilyDetails" %>
         ...
         <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"  href="#">Activity
                       ...
                       <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"href="#" >My Search<b class="caret"></b></a>
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"href="#" >Upgrade<b class="caret"></b></a>
                                 <ul class="dropdown-menu">
                                      <li ><a href="../../Subscription/ViewPackage.aspx">Payment Option</a></li>   <li ><a href="../../Subscription/ViewOrders.aspx">View Orders</a></li>                                                                      <li ><a href="../../Subscription/ViewOrders.aspx">View Orders</a></li>                                                                    
...
<li> <a href="../../Setting/ChangePassword.aspx">Settings</a></li>
   ...
   <li><a href= "EditFamilyDetails.aspx">Edit Partner Family Details</a></li>
</ul>
		 </div>  </div> 
                    <div class="row">
   ...
   <div class="form-group"> 
        ...
        <asp:RadioButton ID="rgbPDnot" runat="server" GroupName="rgbParentsLiving" 
       ...
       <div class="form-group">   <asp:DropDownList ID="ddlFstatus" runat="server"  CssClass="form-control">
 ...
 <div class="col-md-4">  
     ...
     <div class="col-md-8">
       <div class="form-group">   <asp:DropDownList ID="ddlFvalue" runat="server" CssClass="form-control">
      <asp:ListItem>Does Not Matter</asp:ListItem>
 ...
 <div class="col-md-4">  
     ...
     <div class="form-group"> 
        <asp:Button ID="btnFamilySave" runat="server" Text="Save" 
             onclick="btnFamilySave_Click" CssClass="loginbtn"/>
       </div> </div></div>

<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="InfoUpload.aspx.cs" Inherits="InfoUpload" %>
...
<a href="../Activities/Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	<div class="container">		   
             <h3 class="text-center">Upload/Edit Images</h3>
           <div class="row">
                <br />
               </div>
          <div class="row">
       ...
       <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                       <div class="row">
                           <div class="col-lg-5">  <asp:Label ID="Label8" runat="server" Text="Upload Type"></asp:Label></div>
                           <div class="col-lg-7">
                      
          <div class="form-group">   
        
        <asp:DropDownList ID="ddlUploadType" runat="server" required="required" CssClass="form-control"
            AutoPostBack="True" onselectedindexchanged="ddlUploadType_SelectedIndexChanged">
            <asp:ListItem Value="">--Select Type--</asp:ListItem>
            <asp:ListItem>Biodata</asp:ListItem>
         ...
         <div class="row">
                           <div class="col-lg-5">   <asp:Label ID="lblUploadBio" runat="server" Text="Upload Biodata"></asp:Label></div>
                           <div class="col-lg-7">
                      
          <div class="form-group">   
        
       
        <asp:FileUpload ID="fupBiodata" runat="server" CssClass="form-control"/>
       </div>
                               </div>
             </div>
 <div class="row">
                           <div class="col-lg-5"><asp:Label ID="lblPhototype" runat="server" Text="PhotoType"></asp:Label></div>
                           <div class="col-lg-7">
                      
          <div class="form-group">    
        
        <asp:DropDownList ID="ddlPhotoType" runat="server" CssClass="form-control" required="required">
        <asp:ListItem Value="">--PhotoType--</asp:ListItem>
      
        <asp:ListItem>Selfie</asp:ListItem>
        ...
        <asp:ListItem>LifeStyle</asp:ListItem>
                        ...
                        <div class="row">
 <div class="col-lg-5">  <asp:Label ID="lblphoto" runat="server" Text="Photo"></asp:Label></div>
                           <div class="col-lg-7">
                      
          <div class="form-group">    
        
      
        <asp:FileUpload ID="fupPhoto" runat="server" CssClass="form-control"/>
      </div>
                               </div></div>
                        <div class="row">
 <div class="col-lg-5"> <asp:Label ID="lblCaption" runat="server" Text="Caption"></asp:Label></div>
                           <div class="col-lg-7">
        ...
        <asp:TextBox ID="txtCaption" runat="server" CssClass="form-control"></asp:TextBox>
                          ...
                          <div class="row">
                           <div class="col-lg-5">  <asp:Label ID="lblVisibility" runat="server" Text="Visibility"></asp:Label></div>
                           <div class="col-lg-7">
                      
          <div class="form-group">   
   <asp:DropDownList ID="ddlVisibility" runat="server" CssClass="form-control" required="required"
            >
            <asp:ListItem Value="">--Select Visibility--</asp:ListItem>
 ...
 <div class="col-lg-5"> </div>
          ...
          <div class="form-group"> 
        <asp:Button ID="btnUpload" runat="server" Text="Upload" CssClass="loginbtn"
            onclick="btnUpload_Click" />
                   ...
                   <div class="col-lg-1">     </div>
                    <div class="col-lg-4">     
                     ...
                     <h3>Profile Photo</h3>
                              <h5><asp:Label ID="lblprovisibility" runat="server"  /></h5>
     
    <asp:Image ID="imgProfilePic"  CssClass="img-thumbnail" runat="server" Height="150px" Width="150px" />
                    
                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn fa fa-times over iconcolor" onclick="LinkButton2_Click"></asp:LinkButton>
                            <cc1:GroupingView ID="GroupingView3" runat="server" GroupingDataField="varPhotoType"
                          DataSourceID="sqlfamilypic"   oncommand="GroupingView3_Command" >
            <GroupTemplate>
                 <div class="section-heading">
                 <h3><asp:Label ID="lblfamily" runat="server" Text='<%# Eval("varPhotoType") %>' /></h3>
            
                  <h5>Visibility : <asp:Label ID="Label1" runat="server" Text='<%# Eval("varVisibility") %>' /></h5>
                        <div class="line"></div>
                   <%--   <h5>Approval : <asp:Label ID="Label2" runat="server" Text='<%# Eval("varApproval") %>' /></h5>
            ...
            <ItemTemplate>  
                      ...
                      <asp:Image ID="imgfamilyfriend" runat="server" CssClass="img-thumbnail" ImageUrl='<%# "~/members/media/" + Eval("varUploadPath") %>' Width="100px"   Height="100px"  tooltip='<%# Eval("varUploadPath") %>' />

...
public partial class members_ChangePhoto : System.Web.UI.Page
{
    ...
    public void getImage()
    {
        try
        {
            ...
            if (dbc.dr.Read())
            {
                ...
                if (ImageUr != null)
                {
                    imgProfilePic.ImageUrl = "~/members/media/" + ImageUr;
                    gen = dbc.dr["varGender"].ToString();
                }
                //else
                //{
                ...
                //    {
                //        imgProfilePic.ImageUrl = "~/members/media/MaleNoProfile.jpg";

                //    }
                //    else if (dbc.dr["varGender"].ToString() == "Female")
                //    {
                //        imgProfilePic.ImageUrl = "~/members/media/FemaleNoProfile.jpg";
                //    }
                  
                //    else if (dbc.dr["varGender"].ToString() == "Other")
                //    {
                //        imgProfilePic.ImageUrl = "~/members/media/NoProfile.jpg";
                //    }
                //}
            }
            else
            {
                // imgProfilePic.ImageUrl = "~/media/NoProfile.jpg";
                ScriptManager.RegisterStartupScript(
         this,
         this.GetType(),
         "MessageBox",
         "alert('Some problem Please try again...!!!');", true);
            ...
            sqlfamilypic.SelectCommand = "SELECT intId,varPhotoType,varUploadPath FROM  anuvaa_matrimony.tblammemberuploads where varMemberId='" + (Session["memberid"].ToString()) + "' and  varUploadType='Photo' ";
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        try
        {
          ...
          this.GetType(),
          "MessageBox",
          "alert('Profile Image Deleted');window.location='ChangePhoto.aspx';", true);
        }
        catch (Exception ex)
        {
    ...
    protected void GroupingView3_Command(object o, GroupingViewCommandEventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(
                ...
                this.GetType(),
                "MessageBox",
                "alert('Image Deleted');window.location='ChangePhoto.aspx';", true);

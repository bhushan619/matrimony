<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="ConfirmDelete.aspx.cs" Inherits="Members_Setting_ConfirmDelete" %>
...
<li ><a href="../UserProfile/Self/EditPersonalDetails.aspx"> Edit My Profile</a></li>
  ...
  <li class="active"> <a href="ChangePassword.aspx">Settings</a></li>
   ...
   <li><a href= "DeleteProfile.aspx">Delete Profile</a></li>
               ...
               <h4>We are going to miss you...</h4>
                <p>Notes: Your Profile will be deleted soon..</p>
                <p>You will recieve a mail of confirmation after deletion.</p>
                <p>On confirmation you will be agreed to recieve promotional mail and sms from Swapnpurti Matrimony</p>
                <p>For further clarification drop us a line at swapnpurtimatrimony@gmail.com</p>
                    <p>In case in future you would like to join us again kindly use same Log in Id & password.</p>
                      <div class="form-group">  
   <asp:Button ID="Button1"  runat="server" Text="Cancel"  CssClass="btn btn-success" OnClick="Button1_Click"    /> 
                  <asp:Button ID="btnSubmit"  runat="server" Text="Delete Profile"  CssClass="btn btn-danger" OnClick="btnSubmit_Click"  /> 
 </div>
                </div>

<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="DeleteProfile.aspx.cs" Inherits="members_ProfileDelete" %>
...
<head runat="server">
<title>Swapnpurti Matrimony | Delete Profile</title>      <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
  ...
  <li class="active"> <a href="ChangePassword.aspx">Settings</a></li>
          ...
          <div class="row">
               ...
               <div class="list-group"> 
                ...
                <a href="DeleteProfile.aspx" class="list-group-item active">
   ...
   <li><a href= "DeleteProfile.aspx">Delete Profile</a></li>
    ...
    <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="Delete Profile"></asp:Label></div>
   
  We hope you found your life partner and this is the reason you decided to delete your profile. <br />
   Please note that profiles once deleted cannot be restored.
    <br /><br />
 <div class="row"> 
                         <div class="col-md-4"> 
                                 <div class="form-group">   
                               <span>Select the reason for deleting your profile</span> 
                       </div> 
                             </div> 
                      <div class="col-md-8">
             <div class="form-group">       

                 <asp:DropDownList ID="ddlreason" runat="server" CssClass="form-control"  AutoPostBack="true" required="required" OnSelectedIndexChanged="marriage_SelectedIndexChanged">
                     <asp:ListItem Value="">--Select Reason--</asp:ListItem>
                     <asp:ListItem>Married</asp:ListItem>
                     <asp:ListItem>Marriage Fixed</asp:ListItem>
                     <asp:ListItem>Other Reasons</asp:ListItem>
                 </asp:DropDownList>
   
   </div></div></div>
                   <div id="getData" runat="server" visible="false">
 <div class="row"> 
                         <div class="col-md-4"> 
                                 <div class="form-group">   
             ...
             <div class="form-group">  
                 <asp:DropDownList ID="ddlsource" runat="server" CssClass="form-control">
                     ...
                     <asp:ListItem>Through Our Site</asp:ListItem>
                     <asp:ListItem>Through Other Site</asp:ListItem>
    ...
    <asp:TextBox ID="txtMDate" runat="server" CssClass="form-control" required="required"></asp:TextBox>
             <cc1:CalendarExtender ID="txtMDate_CalendarExtender" runat="server" Format="dd-MM-yyyy"
        Enabled="True" TargetControlID="txtMDate">
    </cc1:CalendarExtender>      </div></div></div>
    ...
    <div class="row"> 
                         <div class="col-md-4"> 
                                 <div class="form-group">   
                               <span>Share Experience/Reason to Delete</span> 
                       </div> 
                             </div> 
                      <div class="col-md-8">

             <div class="form-group">  
    <asp:TextBox ID="txtExperience" runat="server" TextMode="MultiLine" required="required" CssClass="form-control"></asp:TextBox>
 </div></div></div>
                        <div class="row"> 
                         <div class="col-md-4"> 
             ...
             <div class="form-group">  
                  ...
                  <asp:Button ID="btnSubmit"  runat="server" Text="Delete Profile"  CssClass="loginbtn" OnClick="btnSubmit_Click"  /> 
 </div></div></div>

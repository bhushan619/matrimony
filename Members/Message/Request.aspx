<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="Request.aspx.cs" Inherits="members_Message_Request" %>

<!DOCTYPE html>

 <html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Swapnpurti Matrimony | Requests</title>     <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<a href="../Activities/Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
  ...
  <li><a href="Send.aspx">Sent</a></li>
  <li class="active"><a href="Request.aspx">Requests&nbsp;<span class="badge"><asp:Label ID="lblrequest" runat="server" Text="0" ></asp:Label></span></a></li>
</ul>
               </div>
          <div class="row">
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
   ...
   <span class="j10font"> The members that are send Requests are displayed here.</span> <br />
 ...
 <ItemTemplate>
        ...
        <div class="col-lg-12 j10fontAbout" style="background-color: #FEFCF4">
             <div class="row "> 
                 <br />
                 <div class="col-lg-1 ">

  <asp:ImageButton ID="imgSimilarPic" runat="server"  CssClass="img-circle" Height="70px" Width="70px" CommandArgument='<%# Eval("SlstMemId") %>'      ImageUrl='<%# "../media/" + Eval("SlstMemPhoto") %>' /> 
</div>
                 <div class="col-lg-1 "></div>
<div class="col-lg-3 ">
  <asp:LinkButton ID="lblCollege" runat="server"    CommandArgument='<%# Eval("SlstMemId") %>' OnClick="OpenProfile" Text='<%# Eval("SlstMemId") %>' Font-Bold="true" Font-Size="14px"></asp:LinkButton> <br /> 
<%-- <asp:Label ID="Label10" runat="server" Text='<%# Eval("SlstMemName") %>' /><br /> --%>
Age :<asp:Label ID="AgeLabel" runat="server" Text='<%# Eval("SlstMemAge") %>' /><br /> 
...
Location :<asp:Label ID="Label3" runat="server" Text='<%# Eval("SlstMemCity") %>' />
  ...
  <div class="col-lg-7"> 
     ...
     <b>Request For &nbsp;<asp:Label ID="EducationLabel" runat="server" Text='<%# Eval("SlstMemReqFor") %>' /> <br /></b>    
  <asp:Label ID="Label4" runat="server" Text='<%# Eval("SlstMemReqType") %>' /> <br />  
         Date : <asp:Label ID="Label7" runat="server" Text='<%# Eval("SlstMemDate") %>' /> 
 Time : <asp:Label ID="Label9" runat="server" Text='<%# Eval("SlstMemTime") %>' /><br /><br /> 
    
    
     <asp:LinkButton runat="server" ID="lnkphoto" OnClick="lnkphoto_Click" CssClass="btn btn-success"   CommandArgument='<%# Eval("SlstMemId") %>' >Accept</asp:LinkButton>
                  <asp:LinkButton runat="server" ID="lnkDeclined" OnClick="lnkDeclined_Click" CssClass="btn btn-warning"   CommandArgument='<%# Eval("SlstMemId") %>' >Declined</asp:LinkButton>  
       <asp:LinkButton ID="LinkButton3" runat="server"    CommandArgument='<%# Eval("SlstMemId") %>'  CssClass="btn btn-danger"    OnClick="DeleteShortlistedProfile" Text="Delete"></asp:LinkButton><br /> 
   ...
   <div class="bordex"></div> 
            ...
            <ItemTemplate >
              ...
              <dt> Request From </dt>
              <dd> <asp:Label ID="varMemberNameLabel" runat="server" Text='<%# Eval("varFromMemberId") +", "+ Eval("varFromMembarName") %>' /></dd>
                  <dt> Request Type </dt>
              <dd> <asp:Label ID="Label2" runat="server" Text='<%# Eval("varRequestType") %>' /></dd>
                  <dt> Date </dt>
              <dd> <asp:Label ID="Label6" runat="server" Text='<%# Eval("varDate") +", "+ Eval("varTime") %>' /></dd>
  <div class="text-right">
     <asp:LinkButton runat="server" ID="lnkphoto" OnClick="lnkphoto_Click" CssClass="btn btn-primary" >Accept</asp:LinkButton>
                  <asp:LinkButton runat="server" ID="lnkDeclined" OnClick="lnkDeclined_Click" CssClass="btn btn-danger">Declined</asp:LinkButton>
                </div>
           </dl> 
              
          
                   </span></ItemTemplate><LayoutTemplate>
                <div id="itemPlaceholderContainer" runat="server" style="">
                    <span runat="server" id="itemPlaceholder" />
                </div>
                <div style="">

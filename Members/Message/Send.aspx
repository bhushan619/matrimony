<%@ Page MaintainScrollPositionOnPostback="true"   Language="C#" AutoEventWireup="true" CodeFile="Send.aspx.cs" Inherits="members_Message_Send" %>

<!DOCTYPE html >

 <html xmlns="http://www.w3.org/1999/xhtml">
 <head>
<title>Swapnpurti Matrimony | Sent Messages</title>     <link rel="alternate" href="http://swapnpurti.in" hreflang="en-in" />  <link rel="shortcut icon" href="../../images/favicon.ico" type="image/x-icon" /><link rel="icon" href="../../images/favicon.ico" type="image/x-icon" />
...
<a href="../Activities/Notification.aspx"> <i class="fa fa-bell-o fa-2x iconcolor"></i>
  ...
  <li class="active"><a href="Send.aspx">Sent</a></li>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
   ...
   <div class="col-lg-2" >
       <asp:ImageButton ID="imgSimilarPic" runat="server" CssClass="img-rounded" Height="60px" Width="60px"   ImageUrl='<%# "~/members/media/" + Eval("SentPhoto") %>' /> 
          ...
          <div class="col-lg-1">
     <asp:LinkButton runat="server" ID="lnkDelete"  CommandArgument='<%# Eval("ConId") %>' CommandName="delet" ><i class="fa fa-trash btn btn-danger"></i></asp:LinkButton></div>
  </div>
                    </span>

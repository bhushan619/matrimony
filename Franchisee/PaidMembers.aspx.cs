...
public partial class Franchisee_PaidMembers : System.Web.UI.Page
{
    ...
    public void getDataInGridview()
    {
        ...
        {
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT  varMemberId, varMembershipType,  varMemberName, varGender, varMobile,varMemberStatus,varCreatorDesignation,varEmail FROM tblammemberregistration WHERE varMembershipType='Paid' and varFranchiseeId='" + frid + "'", dbc.con);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dbc.con.Open();
            MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT  varMemberId, varMembershipType,  varMemberName, varGender, varMobile,varMemberStatus,varCreatorDesignation FROM tblammemberregistration WHERE varMembershipType='Paid' and  varMemberStatus='Verified' and varFranchiseeId='" + frid + "' AND varMemberId='" + arry[0].ToString() + "'", dbc.con);
            MySql.Data.MySqlClient.MySqlDataAdapter ad = new MySql.Data.MySqlClient.MySqlDataAdapter(cmd);
            ad.Fill(dt);
            grdPaidMember.DataSource = dt;
            grdPaidMember.DataBind();
    ...
    protected void grdPaidMember_Sorting(object sender, GridViewSortEventArgs e)
    {

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="SuccessStory.aspx.cs" Inherits="SuccessStory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
          <div class="row">
                <div class="  col-lg-8 bg-lightest border-1px col-lg-offset-2 ">
                  <h3 class="text-theme-colored m-0 ">Success Story</h3>
 ...
 <div class="col-md-6">
         <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control"    ID="txtMembetId" runat="server" 
            ontextchanged="txtMembetId_TextChanged" Placeholder="Your Member Id" AutoPostBack="True" required="required"></asp:TextBox>
     </div>
                      <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control"  Placeholder="Your Name" ID="txtMemberName" runat="server" ReadOnly="True"></asp:TextBox>
       </div> 
      <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control"  Placeholder="Your Partner's Member Id" ID="txtPartnerMemberId" runat="server" required="required"
            ontextchanged="txtPartnerMemberId_TextChanged" AutoPostBack="True"></asp:TextBox>
       </div> 
      <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control" Placeholder="Partner Name"  ID="txtPartnerName" runat="server" ReadOnly="True"></asp:TextBox>
        </div>
                      <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control" Placeholder="Email-Id"  ID="txtEmail" runat="server" required="required"></asp:TextBox>
      </div>
                      <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control"  Placeholder="Engagement Date " ID="txtEngagementDate" runat="server" required="required"></asp:TextBox>
     ...
     <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control"  Placeholder="Marriage Date "  ID="txtMarriageDate" runat="server" required="required"></asp:TextBox>
        <cc1:CalendarExtender ID="txtMarriageDate_CalendarExtender" runat="server" 
          Format="dd-MM-yyyy"  Enabled="True" TargetControlID="txtMarriageDate">
                         ...
                         <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control" Placeholder="Wedding Location"  ID="txtWeddingLocation" runat="server" required="required"></asp:TextBox>
       </div>  
                          
     </div>
                     <div class="col-md-6">
                       <div class="form-group mb-10">
            <asp:TextBox CssClass="form-control" Placeholder="Living Address"  ID="txtLivingAddress" runat="server" TextMode="MultiLine" required="required"></asp:TextBox>
        </div>
                         <div class="form-group mb-10">
...
<asp:ListItem>	Zimbabwe	</asp:ListItem>--%>
        ...
        <asp:ListItem Value="">--Select State--</asp:ListItem>
                       <asp:ListItem>Andhra Pradesh</asp:ListItem>
                         ...
                         <div class="form-group mb-10">
         <asp:DropDownList CssClass="form-control"  ID="cmbcity" runat="server"    >
                                <asp:ListItem>--Select City--</asp:ListItem>
                                </asp:DropDownList>
     
      </div> 
                          <div class="form-group mb-10">
             <asp:TextBox CssClass="form-control" Placeholder="Mobile Number"  ID="txtMobile" runat="server" required="required"></asp:TextBox>
        
       </div> 
                          <div class="form-group mb-10">
        
            <asp:TextBox CssClass="form-control" Placeholder="Success Story"  ID="txtStory" runat="server" TextMode="MultiLine" required="required"></asp:TextBox>
        </div> 
                          <div class="form-group mb-10">
       
        <asp:FileUpload ID="fupProPic" runat="server" Text="Upload Photo" />
     </div> 
                          <div class="form-group  mt-10">
        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-theme-colored"
